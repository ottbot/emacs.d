...
;; ## added by OPAM user-setup for emacs / tuareg ## 4eb4152c5d1ea444c741d92369917d13 ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/Users/rob/.opam/system/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
