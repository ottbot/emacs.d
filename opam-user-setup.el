...
;; ## added by OPAM user-setup for emacs / tuareg ## 770f303f655b85f629a66407fb657f35 ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/Users/rob/.opam/jsc/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
...
;; ## added by OPAM user-setup for emacs / ocp-indent ## c5a38f3e2b7ded9a00cff2f05f1e0f64 ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/Users/rob/.opam/jsc/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/Users/rob/.opam/jsc/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/Users/rob/.opam/jsc/bin/ocp-indent"))
